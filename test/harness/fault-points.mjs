...
export const CATALOG = {
  ...
  // ── 十步事务（§5.2 / §5.3）─────────────────────────────────────────────────
  'tx:step6:pre-ledger': {
    covers: ['one-sided'], owner: 'fake-tx / 事务内核', status: 'live',
    scenario: ['fake-tx'],
  ...
  'tx:item:pre-retire-rename': {
    covers: ['rename-fsync'], owner: 'fake-tx / 事务内核', status: 'live',
    scenario: ['fake-tx'],
  ...
  'cleanup:A:post-tar-tmp': {
    covers: ['cleanup-abc'], owner: 'fake-tx / 事务内核', status: 'live',
    scenario: ['fake-tx'],
  ...
  'cleanup:post-clear-transaction': {
    covers: ['cleanup-abc', 'one-sided'], owner: 'fake-tx / 事务内核', status: 'live',
    scenario: ['fake-tx'],
  ...
  'rollback:pre-direction': {
    covers: ['rollback'], owner: 'fake-tx / 事务内核', status: 'live',
  ...
  'repair:step2:post-intent': {
    covers: ['repair'], owner: 'fake-intents / 事务内核（§5.10 ②）', status: 'live', scenario: ['fake-repair'],
  ...
  'repair:step3:post-clear-ledger-transaction': {
    covers: ['repair', 'one-sided'], owner: 'fake-intents / 事务内核（§5.10 ③）', status: 'live', scenario: ['fake-repair'],
  ...
  'audit-archive:step1:post-intent': {
    covers: ['audit'], owner: 'fake-intents / 事务内核（audit plane ①）', status: 'live', scenario: ['fake-audit'],
