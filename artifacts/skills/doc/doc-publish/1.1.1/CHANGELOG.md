...
版本号语义见 doc-shared/references/pack-interface.md §6。scripts/publish.py ENGINE 版本常量为 1.1（写进 published.json engine.version），按 1.1.0 理解；本文件建立前 1.0 → 1.1 的差异未单独记录，统一并入 1.1.0 条。
