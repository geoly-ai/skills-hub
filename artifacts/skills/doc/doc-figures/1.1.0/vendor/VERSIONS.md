...
```sh
cd ~/.claude/skills/doc-figures/vendor && shasum -a 256 wasm-graphviz-1.29.1/index.js
shasum -a 256 "$(python3 ~/.claude/skills/doc-figures/scripts/mermaid.py --cache-path)"
```
