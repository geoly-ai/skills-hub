...
写门：`python3 ~/.claude/skills/doc-shared/scripts/run_state.py <运行目录> pass-gate --gate D1 --evidence "<用户原话>"`。规则、skip / waive、改版重开见 references/gates.md。
...
```sh
python3 ~/.claude/skills/doc-shared/tests/run_tests.py
```
